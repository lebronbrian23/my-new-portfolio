<div class="h-full w-full flex flex-col gap-4 rounded-xl">
    ...
    <h2 class="text-2xl font-semibold mb-4">{{ __('Navigation Links Management') }}</h2>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <table class="border-collapse border border-gray-400 w-full">
                <thead class="bg-gray-800 text-white">
                    <tr>
                        ...
                        <th class="border border-gray-300 px-2 py-1">Route</th>
                        <th class="border border-gray-300 px-2 py-1">Icon</th>
                        <th class="border border-gray-300 px-2 py-1">Location</th>
                        <th class="border border-gray-300 px-2 py-1">Position</th>
                ...
                <tbody>
                    @foreach ($links as $link)
                        <tr class="hover:bg-gray-50 dark:hover:bg-neutral-800">
                            <td class="border border-gray-300 px-2 py-1">{{ $link->id }}</td>
                            <td class="border border-gray-300 px-2 py-1">{{ $link->link_name }}</td>
                            <td class="border border-gray-300 px-2 py-1">{{ $link->link_route }}</td>
                            <td class="border border-gray-300 px-2 py-1">{{ $link->link_icon }}</td>
                            <td class="border border-gray-300 px-2 py-1">{{ $link->link_location }}</td>
                            <td class="border border-gray-300 px-2 py-1">{{ $link->link_position }}</td>
        ...
        <div class="rounded-xl border border-neutral-200 dark:border-neutral-700 p-4">
            <h3 class="text-xl font-semibold mb-4">{{ __('Add / Edit Navigation Link') }}</h3>

            <form wire:submit.prevent="save" action="">

                <div class="mb-2">
                    <label class="block mb-1 font-medium" for="link_name"> Name</label>
                    <input type="text" wire:model="link_name" id="link_name" placeholder="link name" class="w-full p-2 border border-gray-300 rounded">
                    @error('link_name') <span class="text-red-600 text-sm">{{ $message }}</span> @enderror
                </div>

                <div class="mb-2">
                    <label class="block mb-1 font-medium" for="link_route">Route</label>
                    <input type="text" wire:model="link_route" id="link_route" placeholder="link route" class="w-full p-2 border border-gray-300 rounded">
                    @error('link_route') <span class="text-red-600 text-sm">{{ $message }}</span> @enderror
                </div>

                <div class="mb-2">
                    <label class="block mb-1 font-medium" for="link_icon">Icon</label>
                    <input type="text" wire:model="link_icon" id="link_icon" placeholder="link icon" class="w-full p-2 border border-gray-300 rounded">
                    @error('link_icon') <span class="text-red-600 text-sm">{{ $message }}</span> @enderror
                </div>

                <div class="mb-2">
                    <label class="block mb-1 font-medium" for="link_location">Location</label>
                    <select wire:model="link_location" id="link_location" class="w-full p-2 border border-gray-300 rounded">
                ...
                <div class="mb-2">
                    <label class="block mb-1 font-medium" for="link_position">Position</label>
                    <input type="number" wire:model="link_position" id="link_position" placeholder="link position" class="w-full p-2 border border-gray-300 rounded">
                    @error('link_position') <span class="text-red-600 text-sm">{{ $message }}</span> @enderror
                </div>

                <div class="mb-4">
                    <label class="block mb-1 font-medium" for="link_status">Status</label>
                    <select wire:model="link_status" id="link_status" class="w-full p-2 border border-gray-300 rounded">
